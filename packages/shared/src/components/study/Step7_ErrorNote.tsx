...
export default function Step7_ErrorNote({
  ...
  const handleAdd = () => {
    ...
    onAddNote({
      ...
      errorType,
      originalText: getSegmentText(seg),
      userHeard,
      explanation,
      isResolved: false,
    });
    ...
    <div className="space-y-4 max-h-[80vh] overflow-y-auto pr-1">
        ...
        {problemIndices.length === 0 ? (
          ...
          problemIndices.map((idx) => {
            ...
            return (
              ...
              >
                <p className="text-sm text-gray-900">{seg ? getSegmentText(seg) : ''}</p>
      ...
      {selectedIdx !== null && segments[selectedIdx] && (
        <div className="bg-gray-50 rounded-lg p-3 space-y-3">
          <div>
            <p className="text-sm font-medium text-gray-900">{getSegmentText(segments[selectedIdx])}</p>
