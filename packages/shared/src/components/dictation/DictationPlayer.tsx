...
import { getSegmentText, getDictationPlaceholder } from '../../lib/languageHelpers';
...
export default function DictationPlayer({
  ...
  const submitAnswer = useCallback(() => {
    ...
    const correctText = getSegmentText(currentSeg);
    const result = scoreDictation(correctText, userInput, getDefaultLanguage());
          ...
          {phase === 'typing' && (
            <div className="space-y-3">
              ...
              <textarea
                ...
                placeholder={getDictationPlaceholder()}
                rows={2}
