        ...
        >
          {!revealed ? (
            <div className="text-center py-4">
              ...
              <p className="text-xs text-indigo-500 mt-1">탭 / <kbd className="px-1 py-0.5 bg-white border border-gray-300 rounded text-[10px]">Space</kbd></p>
            </div>
          ) : (
            <div>
              <p className="text-sm text-gray-900 leading-relaxed">{currentSeg.textEn}</p>
